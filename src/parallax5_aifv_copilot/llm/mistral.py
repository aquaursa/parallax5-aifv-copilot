"""Mistral adapter — targets labs-leanstral-2603 by default.

Mistral's `labs-leanstral-2603` is the Lean-finetuned variant the
PARALLAX-5 roadmap names. It has a 196K-token context window. Default
model is set to that pin; for benchmarks comparing Lean-specialized vs
general models, swap to magistral-medium or mistral-large.
"""
